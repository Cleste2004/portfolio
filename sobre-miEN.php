      ...
      <div class="container">
          <div class="row">
              <div class="col-sm-5 col-12 mt-4">
                  ...
                  <p class="pb-sm-5 magnate">Magnate de la tecnologia.</p>
                  <a href="" class="btn5">Descargar CV</a>
          ...
          <div class="container">
              <div class="row">
                  <div class="col-12 pb-5">
                      <h2 class="pt-4">Stack tecnológico</h2>
                  </div>
              </div>
              <div class="row">
            ...
            <div class="col-12  m-3 ">
                <div class="row ">
                    ...
                    <div class="col-12- col-sm-10 ">
                        ...
                        <h4>2016 - 2018</h4>
                        <p class="sobremi">TAUSEM S.A. es una empresa fabricante de Compresores, Booster y Bombas de vacío de "SISTEMA PENDULAR" UNICO DE PISTON Y CARTER SECO, 100% libre de aceite -Oil free- en todos sus componentes</p>
            ...
            <div class="col-12 ">
              <div class="row">
                  ...
                  <div class="col-12- col-sm-10 px-4">
                      <h2 class="sobreh2">Drogueria MedCare </h2>
          ...
          <div class="row bg-white experiencia">
              ...
              <div class="col-12 col-sm-6">
                  <div class="row">
                      ...
                      <div class="col-12- col-sm-10 p-3">
                          <h3>Tecnico Electromecanico</h3>
                          <h4>Instituto La Salle de San Martin</h4>
                          <h5>2012 – 2018</h5>
