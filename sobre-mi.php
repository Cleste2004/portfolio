      ...
      <section class="container ">
        ...
        <div class="row rounded experiencia">
            ...
            <div class="col-12 ">
              <div class="row">
                  <div class="col-2 p-5 my-auto d-none d-sm-block">
                      <img src="imagenes/Logo-MEDCARE.png" class="img-fluid baw" title="">
                  </div>
                  <div class="col-12- col-sm-10 p-3">
      ...
      <section id="formacion" class="container">
          ...
          <div class="row bg-white experiencia">
              <div class="col-12 col-sm-6">
                  <div class="row">
                      <div class="col-2 py-3 my-auto d-none d-sm-block">
                          <img src="imagenes/logo-depc.jpg" class="img-fluid baw" title="depcsuite">
                      </div>
                      <div class="col-12- col-sm-10 p-3">
              ...
              <div class="col-12 col-sm-6">
                <div class="row">
                    <div class="col-2 py-3 my-auto d-none d-sm-block">
                        <img src="imagenes/unsam (1).png" class="img-fluid baw" title="depcsuite">
                    </div>
                    <div class="col-12- col-sm-10 p-3">
              ...
              <div class="col-12 col-sm-6">
                  <div class="row">
                      <div class="col-2 py-3 my-auto d-none d-sm-block">
                          <img src="imagenes/logo_lasalle.png" class="img-fluid baw">
                      </div>
                      <div class="col-12- col-sm-10 p-3">
                          <h3>Tecnico Electromecanico</h3>
                          <h4>Colegio La Salle de San Martin</h4>
                          <h5>2012 – 2018</h5>
                      </div>
                  </div>
              </div>
